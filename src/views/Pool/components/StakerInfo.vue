<template>
  <div class="ui-box-corners text-14" v-if="poolId === stakerPoolId">
...
export default defineComponent({
  ...
  setup() {
    ...
    const stakedStr = useTokenAmountFormat(stakedAmount, 'SLN', 2)
    const earnedStr = useTokenAmountFormat(earnedAmountAnimated, 'SLN', 9)
    ...
    watch(stakerState, ({ timestamp }) => { lifeTimestamp.value = timestamp })
