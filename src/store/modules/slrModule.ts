...
export const slrModule = createModule('slr', {
  ...
  actions: {
    async fetchPrice() {
      ...
      try {
        const slrPrice = await fetchPrice(contractsAddresses.SolarToken, ['0x24E91664B6098e7e36C3eB59a599d80299838847', '0xAE4C99935B1AA0e76900e86cD155BFA63aB77A2a', '0xF8E4ce287E0D1f9c9fda5EC917515cB87D9C1E6C', '0x5126C1B8b4368c6F07292932451230Ba53a6eB7A'])
