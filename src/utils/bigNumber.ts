...
export const bigToWei = (value: BigNumber, decimals: number, roundingMode: BigNumber.RoundingMode = BigNumber.ROUND_DOWN) =>
  BigNumberEthers.from(value.times(bigTenPow(decimals)).integerValue(roundingMode).toFixed())
